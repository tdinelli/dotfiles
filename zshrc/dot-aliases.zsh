...
alias set-dakota-6.19.0-clang="export PATH=$NUMERICAL_LIBRARIES/dakota/dakota-6.19.0-clang-18.1.7/bin:$PATH,export DYLD_LIBRARY_PATH=$NUMERICAL_LIBRARIES/dakota/dakota-6.19.0-clang-18.1.7/lib:$DYLD_LIBRARY_PATH"
